...
export function Recharge () {
    ...
    <FondoPag>
        ...
        <div> 
            ...
            <header className="recharge-header">
                <button className="btn-atras" onClick={ () => Navigate ("/homeBalance") }><GoChevronLeft/></button>
    ...
    <main className="recharge-contenido">
        ...
        <div className="section-check">
            <input type="checkbox" />
            <span>Autorizo el tratamiento de datos personales conforme a la ley 1581 del 2012</span>
        </div>

         <button className="btn-continuar" onClick={()=> Navigate ("/ConfirmarInfo")}> Continuar </button>
