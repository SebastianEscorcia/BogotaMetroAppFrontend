...
export default function Tarjetametro() {
  const navigate = useNavigate();
  const opciones = ["Personalizar tarjeta", "Reponer tarjeta por pérdida", "Tarjeta Cívica", "Beneficios de usuario"];
  ...
  return (
    <div className="relative z-10 flex flex-col h-full w-full">
      <header className="bg-[#E30613] text-white p-6 pt-14 flex items-center shadow-lg">
        ...
        <h1 className="flex-1 text-center text-3xl font-extrabold">Tarjeta Met.</h1>
      </header>
      <main className="p-6 flex-1 flex flex-col overflow-y-auto">
        <h2 className="text-black text-xl font-extrabold mb-4 text-center italic">Tu llave al sistema</h2>
