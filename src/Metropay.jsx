...
export default function Metropay() {
  const navigate = useNavigate();
  const opciones = ["¿Qué es MetroPay?", "¿Cómo crear mi cuenta?", "Problemas con el pago", "Certificado de transacciones"];
  ...
  return (
    <div className="relative z-10 flex flex-col h-full w-full">
      <header className="bg-[#E30613] text-white p-6 pt-14 flex items-center shadow-lg">
        ...
        <h1 className="flex-1 text-center text-3xl font-extrabold">MetroPay</h1>
      </header>
      <main className="p-6 flex-1 flex flex-col overflow-y-auto">
        <h2 className="text-black text-xl font-extrabold mb-4 text-center italic">¿Cómo podemos ayudarte?</h2>
